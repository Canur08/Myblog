...
const katex = (md, options = { throwOnError: false }) => {
    ...
    const katexInline = (tex) => {
        ...
        try {
            ...
            if (katexOptions.throwOnError)
                console.warn(error);
            return `<span title='${(0, shared_1.htmlEscape)(error.toString())}'>${(0, shared_1.htmlEscape)(tex)}</span>`;
        }
    };
    const katexBlock = (tex) => {
        ...
        try {
            ...
            if (katexOptions.throwOnError)
                console.warn(error);
            return `<p class='katex-error' title='${(0, shared_1.htmlEscape)(error.toString())}'>${(0, shared_1.htmlEscape)(tex)}</p>`;
        }
    };
